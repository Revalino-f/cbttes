...
<head>
	...
	<link rel="shortcut icon" href="./foto/smanip transparant.png" type="image/x-icon">
			...
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						...
						<li class='treeview'><a href='?pg=importmaster'><i class="fas fa-upload side-menu-icon fa-fw   "></i> <span>Import Master Data</span></a></li>
							<li class=' treeview'>
								<a href='#'>
				...
				<?php if ($pg == '') : ?>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						<div class='row'>
							...
							<div class='row'>
							<div class="col-lg-3">
								<div class="small-box"  style="background: linear-gradient(to right, #363795, #005c97); color: white;">
									<div class="inner">
										<h3><?= $siswa ?></h3>
										<p>Jumlah Siswa</p>
									</div>
									...
									<a href="?pg=siswa" class="small-box-footer">Cek <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
							
							<!--sesi  -->
							<div class="col-lg-3">
									<div class="small-box"  style="background: linear-gradient(to right, #493240, #ff0099); color: white;">
									<div class="inner">
										<h3><?= $kelas ?></i></h3>
										<p>Jumlah Kelas</p>
									</div>
									...
									<a href="?pg=kelas" class="small-box-footer">Cek <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
							
							<!-- Nilai  -->
							<div class="col-lg-3 ">
								<div class="small-box"  style="background: linear-gradient(to right, #799f0c, #ffe000); color: white;">
									<div class="inner">
										<h3><?= $nilai ?></h3>
										<p>Jumlah Nilai</p>
									</div>
									...
									<a href="?pg=nilai&id=1" class="small-box-footer">Cek <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
								
							<div class="col-lg-3">
								<div class="small-box" style="background: linear-gradient(to right, #141517, #6a9113); color: white;">
									<div class="inner">
										<h3><?= $soal ?></h3>
										<p>Bank Soal</p>
									</div>
									...
									<a href="?pg=banksoal" class="small-box-footer">Cek <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>

							<div class="col-lg-3">
								<div class="small-box"  style="background: linear-gradient(to right, #f80759, #bc4e9c); color: white;">
									<div class="inner">
										<h3><i class="fa fa-sync"></i></h3>
										<p>Reset Siswa</p>
									</div>
									<div class="icon">
										<i class="fa fa-sync"></i>
									</div>
									<a href="?pg=reset" class="small-box-footer">Cek <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
							
							<!-- Log-->
							<div class="col-lg-3">
								<div class="small-box"  style="background: linear-gradient(to right, #2b32b2, #1488cc); color: white;">
									<div class='inner'>
								...
								<a href="?pg=jadwal" class="small-box-footer">Cek Jadwal <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
							<!-- Absen -->
							<div class="col-lg-3">
								<div class="small-box" style="background: linear-gradient(to right, #5f2c82, #49a09d); color: white;">
									<div class="inner">
									...
									<a href="?pg=absen" class="small-box-footer">Cetak <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
							<!-- Berita Acara -->
							<div class="col-lg-3">
								<div class="small-box" style="background: linear-gradient(to right, #333399, #ff00cc); color: white;">
									<div class="inner">
									...
									<a href="?pg=berita" class="small-box-footer">Cetak <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
							</div>
