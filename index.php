    ...
    <div class='wrapper'>
        ...
        <aside class='main-sidebar'>
            <section class='sidebar'>
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
                    ...
                    <li><a href='<?= $homeurl ?>/materi'><i class='fas fa-tasks fa-fw  '></i> <span> Materi</span></a></li>
                    <li><a href='<?= $homeurl ?>/sholat'><i class='fas fa-calendar fa-fw'></i> <span>Jadwal Sholat</span></a></li>
                    <li><a href='<?= $homeurl ?>/lihathasil'><i class='fas fa-calendar fa-fw'></i> <span>Laporan</span></a></li>
        ...
        <div class='content-wrapper' style='background-image: url(admin/backgroun.jpg);background-size: cover;'>
            ...
            <section class='content' style="margin-top:-95px">
                ...
                <?php elseif ($pg == 'sholat') : ?>
                    <?php include "sholat.php"; ?>
