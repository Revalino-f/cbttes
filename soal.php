...
<style>
    ...
    /* Menghilangkan scroll body */
</style>

<div id="overlay">
    <div id="modal">
        <p class="label bg-blue" style="font-size:larger;">Dilarang keluar dari ujian </p>
        <p class="label bg-blue" style="font-size:larger;">ingin Melanjutkan ujian?</P>
        <button class='done-btn btn  btn-primary' onclick="goFullScreen()">Oke</button>
    </div>
</div>
...
<script>
    ...
    document.addEventListener("fullscreenchange", function() {
        if (!document.fullscreenElement) {
            // If not in fullscreen, show the overlay
            showModal();
        }
    });
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Fungsi untuk menangani event scroll dan refresh
        function handleScrollAndRefresh() {
            enterFullscreen();
        }

        // Tambahkan event listener untuk scroll
        window.addEventListener("scroll", handleScrollAndRefresh);

        // Tambahkan event listener untuk refresh
        window.addEventListener("beforeunload", handleScrollAndRefresh);
    });
</script>